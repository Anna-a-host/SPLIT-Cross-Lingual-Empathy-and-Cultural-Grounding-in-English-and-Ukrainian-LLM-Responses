...
OUTPUT_CSV = "results/evaluations_by_LLMs/evaluation_claude.csv"
...
def judge_response(user_query, assistant_response):
    ...
    try:
        completion = client.chat.completions.create(
            ...
            temperature=0.1, # enforces high coding and grading stability
            timeout=25
        )
...
def main():
    ...
    with open(INPUT_CSV, "r", encoding="utf-8") as infile, \
        ...
        for count, row in enumerate(reader, 1):
            ...
            # parsing array mapping 3 tested target models across both languages
            eval_segments = [
